    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPay.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Card card = new Card(txtcardnumber.getText().toString(), txtcvv.getText().toString(),
                        Integer.parseInt(txtmonth.getText().toString()),
                        Integer.parseInt("20" + txtyear.getText().toString()), txtemail.getText().toString());

                Token token = new Token("pk_test_XG0pzDxJ21rrgcw4");
